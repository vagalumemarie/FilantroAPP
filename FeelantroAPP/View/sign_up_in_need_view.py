...
class SignUpInNeedView(Screen):
    def __init__(self, **kwargs):
        super(SignUpInNeedView, self).__init__(**kwargs)
        ...
        self.entry_label = UITitle(text="Реєстрація громадянина")
    ...
    def switch_screen(self, instance, *args):
        ...
        if self.data_filled_correctly:
            ...
            RequestModel.post_data_registration_users(instance, user_info)
